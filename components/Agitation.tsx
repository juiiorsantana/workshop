                ...
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white/60 backdrop-blur-xl border border-white p-8 md:p-12 rounded-[3rem] shadow-soft-xl relative overflow-hidden">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {pains.map((pain, i) => (
                                <div key={i} className="flex items-center gap-4 p-6 rounded-2xl bg-white border border-slate-100 hover:border-primary/30 shadow-soft-sm hover:shadow-soft transition-all duration-300 group">
